...
impl algotrading::core::traits::MarketDataSource for BenchmarkDataSource {
    fn next_update(&mut self) -> Option<algotrading::core::MarketUpdate> {
        if self.index < self.events.len() {
            ...
            match event {
                MarketEvent::Trade(trade) => Some(algotrading::core::MarketUpdate::Trade(
                    algotrading::core::Trade {
                ...
                MarketEvent::BBO(bbo) => Some(algotrading::core::MarketUpdate::BBO(
                    algotrading::core::BBO {
        ...
        group.bench_with_input(
            ...
            |b, &num_events| {
                ...
                b.iter(|| {
                    ...
                    let _report = engine
                        .run_with_data_source(Box::new(data_source))
...
impl Strategy for SimpleOrderStrategy {
    ...
    ) -> Result<(), algotrading::strategy::StrategyError> {
        Ok(())
    }
