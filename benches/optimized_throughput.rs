...
use algotrading::market_data::reader_optimized::{
    IndexedFeatureVector, MarketSnapshot, feature_indices,
};
            ...
            |b, &num_events| {
                ...
                b.iter(|| {
                    ...
                    if num_events == 1_000_000 {
                        println!(
                            "\nOptimized market updates: {:.0} events/second",
                            throughput
                        );
                    }
...
fn convert_update_to_event(update: &MarketUpdate) -> algotrading::market_data::events::MarketEvent {
    match update {
        MarketUpdate::Trade(trade) => algotrading::market_data::events::MarketEvent::Trade(
        ...
        MarketUpdate::BBO(bbo) => algotrading::market_data::events::MarketEvent::BBO(
        ...
        _ => algotrading::market_data::events::MarketEvent::Trade(
            algotrading::market_data::events::TradeEvent {
                instrument_id: 1,
                trade_id: 0,
