...
impl MeanReversionStrategy {
    ...
    fn create_order(&self, signal: Signal, current_price: Price, context: &StrategyContext) -> Option<OrderRequest> {
...
use crate::strategy::output::OrderType;
    ...
    fn test_signal_generation() {
        ...
        assert_eq!(signal, Signal::Long, "Low price {} should generate Long signal (z-score: {})", low_price, (low_price - mean) / std);
        ...
        assert_eq!(signal, Signal::Short, "High price {} should generate Short signal", high_price);
        ...
        assert_eq!(signal, Signal::ExitLong, "Reverted price should generate ExitLong signal");
        ...
        assert_eq!(signal, Signal::ExitShort, "Reverted price should generate ExitShort signal");
    }
    ...
    fn test_statistics_calculation() {
        ...
        assert!((mean - 100.0).abs() < 0.1, "Mean {} should be close to 100", mean);
    ...
    fn test_order_creation_variants() {
        ...
        let order = strategy.create_order(Signal::ExitLong, Price::new(10000i64), &context_with_position);
        assert!(order.is_some());
        let order = order.unwrap();
    ...
    fn test_edge_cases_and_error_handling() {
        ...
        let order = strategy2.create_order(Signal::ExitLong, Price::from_f64(100.0), &context_large_pos);
        assert!(order.is_some());
        let order = order.unwrap();
