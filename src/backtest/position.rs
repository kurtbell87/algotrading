...
impl PositionTracker {
    ...
    pub fn check_risk_limits(&self, instrument_id: InstrumentId, new_quantity: i64) -> Result<(), RiskViolation> {
...
impl PositionManager {
    ...
    pub fn apply_fill(&mut self, fill: &FillEvent) -> Result<(), String> {
        let tracker = self.strategy_trackers
        ...
        tracker.check_risk_limits(fill.instrument_id, new_qty)
