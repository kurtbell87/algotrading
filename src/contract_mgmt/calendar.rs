...
fn get_nth_weekday_of_month(year: i32, month: Month, weekday: Weekday, n: u8) -> Date {
    ...
    panic!("Could not find {} occurrence of {:?} in {}-{}", n, weekday, year, month);
}
...
mod tests {
    ...
    fn test_contract_month_from_code() {
        ...
        assert_eq!(ContractMonth::from_code('U'), Some(ContractMonth::September));
    ...
    fn test_expiration_dates() {
        ...
        assert_eq!(get_expiration_date(2025, ContractMonth::March), date!(2025-03-21));
        
        // June 2025 third Friday is June 20
        assert_eq!(get_expiration_date(2025, ContractMonth::June), date!(2025-06-20));
        
        // September 2025 third Friday is September 19
        assert_eq!(get_expiration_date(2025, ContractMonth::September), date!(2025-09-19));
        
        // December 2025 third Friday is December 19
        assert_eq!(get_expiration_date(2025, ContractMonth::December), date!(2025-12-19));
    }
    
    #[test]
    fn test_roll_dates() {
        // March 2025 second Thursday is March 13
        assert_eq!(get_roll_date(2025, ContractMonth::March), date!(2025-03-13));
        
        // June 2025 second Thursday is June 12
        assert_eq!(get_roll_date(2025, ContractMonth::June), date!(2025-06-12));
        
        // September 2025 second Thursday is September 11
        assert_eq!(get_roll_date(2025, ContractMonth::September), date!(2025-09-11));
        
        // December 2025 second Thursday is December 11
        assert_eq!(get_roll_date(2025, ContractMonth::December), date!(2025-12-11));
    }
    
    #[test]
    fn test_get_front_month() {
        // Before March roll
        assert_eq!(get_front_month(date!(2025-03-01)), (ContractMonth::March, 2025));
        assert_eq!(get_front_month(date!(2025-03-12)), (ContractMonth::March, 2025));
        
        // After March roll, before June roll
        assert_eq!(get_front_month(date!(2025-03-13)), (ContractMonth::June, 2025));
        assert_eq!(get_front_month(date!(2025-05-01)), (ContractMonth::June, 2025));
        
        // After June roll, before September roll
        assert_eq!(get_front_month(date!(2025-06-12)), (ContractMonth::September, 2025));
        assert_eq!(get_front_month(date!(2025-08-01)), (ContractMonth::September, 2025));
        
        // After September roll, before December roll
        assert_eq!(get_front_month(date!(2025-09-11)), (ContractMonth::December, 2025));
        assert_eq!(get_front_month(date!(2025-11-01)), (ContractMonth::December, 2025));
        
        // After December roll
        assert_eq!(get_front_month(date!(2025-12-11)), (ContractMonth::March, 2026));
        assert_eq!(get_front_month(date!(2025-12-31)), (ContractMonth::March, 2026));
    }
    
    #[test]
    fn test_is_in_roll_period() {
        // Test June 2025 roll period (June 12-20)
        assert!(!is_in_roll_period(date!(2025-06-11), ContractMonth::June, 2025));
        assert!(is_in_roll_period(date!(2025-06-12), ContractMonth::June, 2025));
        assert!(is_in_roll_period(date!(2025-06-19), ContractMonth::June, 2025));
        assert!(!is_in_roll_period(date!(2025-06-20), ContractMonth::June, 2025));
    }
}