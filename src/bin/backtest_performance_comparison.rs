...
use algotrading::backtest::engine_fast::{FastBacktestEngine, FastBacktestConfig};
...
fn main() {
    ...
    println!("Fast engine: {:.0} events/s ({:.1}x improvement)", 
            fast_throughput, fast_throughput / original_throughput);
