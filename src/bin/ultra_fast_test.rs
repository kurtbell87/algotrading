...
fn main() {
    ...
    // Compare
    println!("\n=== COMPARISON ===");
    println!("Original: {:.0} events/s ({:.1}% of 18M)", 
            original, (original / 18_000_000.0) * 100.0);
    println!("Ultra-fast: {:.0} events/s ({:.1}% of 18M)", 
            ultra_fast, (ultra_fast / 18_000_000.0) * 100.0);
